...
define('TEXT_MENU_ICON_TITLE_TOOLTIP','Введите название иконки из библиотеки Font Awesome, например: fa-bell. <a href="http://fortawesome.github.io/Font-Awesome/icons/" target="_blank">Просмотреть список доступных иконок</a>');
...
define('TEXT_ENTER_TEXT_PATTERN_INFO','Используйте [ID поля] для установки значения поля в шаблоне.<br> Пример: "[36]ваш текст[54]" где 36 и 54 - идентификаторы полей.<br>Так же, доступны: [id], [date_added], [created_by]');
...
define('TEXT_DATABASE_EXPORT_EXPLANATION','Данная функция создает шаблон вашего приложения.<br>Экспортируются  только те данные, которые относятся к настройкам вашего приложения.<br>С помощью шаблона, вы можете клонировать ваше приложение или поделиться им.');
define('TEXT_DATABASE_EXPORT_TOOLTIP','<b>Примечание:</b> экспортируется только текущий пользователь и его Логин/Пароль, которые используются для входа в систему после установки шаблона.<br>Для установки шаблона, файл шаблона нужно скопировать в папку /backups на вашем сервер, и на странице "Резервное копирование базы данных" восстановить базу данных из шаблона.');
