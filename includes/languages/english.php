...
define('TEXT_ENTER_TEXT_PATTERN_INFO','Use [ID field] to set the value of the field in the template.<br>Example: "[36] your text [54]" where the 36 and 54 - fields ID.<br>Also available: [id], [date_added], [created_by]');
...
define('TEXT_DATABASE_EXPORT_TOOLTIP','<b>Note:</b> export only the current user and his Login/Password which you can use to login to the system after installation of the template.<br>To install the template, the template file must be copied to /backups folder on your server and on the page "Database Backup" restore a database from a template.');
