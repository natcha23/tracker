...
class fieldtype_boolean
{
  ...
  static function get_choices($field, $add_empty)
  {
    $cfg = new fields_types_cfg($field['configuration']);
  ...
  function reports_query($options)
  {
    ...
    $sql_query[] = $options['prefix'] . 'field_' . $filters['fields_id'] .  ($filters['filters_condition']=='include' ? ' = ': ' != ') . "'" . $filters['filters_values'] . "'";
