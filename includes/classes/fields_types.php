...
class fields_types
{
  ...
  {  
    $fieldtypes[TEXT_FIELDS_TYPES_GROUP_INPUT_FIELDS] = array('fieldtype_input',
    ...
    $fieldtypes[TEXT_FIELDS_TYPES_GROUP_DATES] = array('fieldtype_input_date',
                                                       'fieldtype_input_datetime');
                                                           
                                                        
    $fieldtypes[TEXT_FIELDS_TYPES_GROUP_TEXT] = array('fieldtype_textarea',
                                                      'fieldtype_textarea_wysiwyg',
                                                      'fieldtype_text_pattern');
    
    $fieldtypes[TEXT_FIELDS_TYPES_GROUP_UPLOAD] = array('fieldtype_attachments',
                                                        'fieldtype_input_file',
                                                        'fieldtype_image',
                                                        );                                                  
                                                      
    $fieldtypes[TEXT_FIELDS_TYPES_GROUP_LIST] = array('fieldtype_boolean',
                                                      'fieldtype_dropdown',
                                                      'fieldtype_dropdown_multiple',                                                      
    ...
    $fieldtypes[TEXT_FIELDS_TYPES_GROUP_USERS] = array('fieldtype_users',
                                                       'fieldtype_grouped_users');
                                                       
    $fieldtypes[TEXT_FIELDS_TYPES_GROUP_ENTITY] = array('fieldtype_entity',
                                                       'fieldtype_related_records');     
