  ...
  public static function render_content_box($entity_id,$item_id,$user_id)
  {
    ...
    while($item = db_fetch_array($items_query))
    {
      ...
      while($field = db_fetch_array($comments_fields_query))
      {
        ...
        $html_fields .='                      
            <tr><th style="text-align: left; font-family:Arial;font-size:13px;">&bull;&nbsp;' . $field['name'] . ':&nbsp;</th><td style="font-family:Arial;font-size:13px;">' . fields_types::output($output_options). '</td></tr>           
        ';
      }
