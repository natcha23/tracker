...
<?php
  ...
  $choices = array(''=>TEXT_NO,'view,create,update,delete'=>TEXT_YES,'view,create'=>TEXT_CREATE_ONLY_ACCESS,'view'=>TEXT_VIEW_ONLY_ACCESS);
  ...
  {        
    ...
    {
      $schema = $acess_info['access_schema'];                    
    }
