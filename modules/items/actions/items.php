...
{  
  ...
  case 'delete':
      ...
      choices_values::delete_by_item_id($current_entity_id,$_GET['id']);
      
      related_records::delete_related_by_item_id($current_entity_id,$_GET['id']);
  ...
  case 'check_unique':
      ...
      $check_query = db_query("select count(*) as total from app_entity_" . $current_entity_id .  " where field_" . $_POST['fields_id'] . "='" . db_input($_POST['fields_value'])  . "'" . (isset($_GET["id"]) ? " and id!='" . db_input($_GET['id']) . "'":""));
