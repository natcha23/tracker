...
<?php echo button_tag(TEXT_BUTTON_ADD_NEW_VALUE,url_for('global_lists/choices_form','lists_id=' . $_GET['lists_id']),true,array('class'=>'btn btn-primary')) . ' ' . button_tag(TEXT_BUTTON_SORT,url_for('global_lists/choices_sort','lists_id=' . $_GET['lists_id']),true,array('class'=>'btn btn-default')) ?>
