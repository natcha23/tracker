...
switch($field_info['type'])
{
  ...
  case 'fieldtype_users':
      ...
      {
        $users_query_assigned_only = " where u.id in (select cv.value from app_choices_values cv where cv.entities_id='" . db_input($field_info['entities_id']) . "' and cv.fields_id='" . db_input($field_info['id']) . "' and cv.items_id in (select cvi.items_id from app_choices_values cvi where cvi.entities_id='" . db_input($field_info['entities_id']) . "' and cvi.fields_id='" . db_input($field_info['id']) . "' and cvi.value='" . db_input($app_user['id']) . "'))";        
      }
