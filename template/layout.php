...
<link href="template/plugins/font-awesome/css/font-awesome.min.css?v=4.6.0" rel="stylesheet" type="text/css"/>
...
<!-- BEGIN BODY -->
<body class="page-header-fixed <?php echo $app_users_cfg->get('sidebar-option','') . ' ' . $sidebar_pos_option . ' ' . $app_users_cfg->get('page-scale-option','') ?>">
